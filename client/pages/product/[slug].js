            ...
            <section className="text-black-600 body-font overflow-hidden">
                <div className="container px-4 py-10 mx-auto">
                    <div className="lg:w-3/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={product.attributes.img_url} />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <p className="mt-2 bg text-slate-900">{product.attributes.author}</p>

                            <div className="flex mt-4">
                                <span className="title-font font-medium text-2xl text-gray-900">Rs.{product.attributes.price}</span>
                                <div className="flex mx-4">
                                    <button className="flex ml-auto mx-2 text-white bg-orange-600 border-0 py-2 px-2 focus:outline-none hover:bg-orange-500 rounded">Buy Now</button>
                                    <button className="flex ml-auto mx-2 text-white bg-orange-600 border-0 py-2 px-2 focus:outline-none hover:bg-orange-500  rounded">Add to Cart</button>
                                </div>
                            </div>
                        </div>
                    </div>
